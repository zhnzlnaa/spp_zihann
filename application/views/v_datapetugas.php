...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background-color: #f2cdb6;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="<?php echo site_url('datapetugas/form');?>" class="btn btn-danger">Tambah</a><br><br>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <div class="tooltip-demo">
                                                    <a
                                                        href="<?php echo site_url('datapetugas/formedit/'.$d['id_petugas']);?>">
                                                        <span class='glyphicon glyphicon-edit' data-toggle='tooltip'
                                                            data-placement='top' title='Ubah'></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
